...
namespace PSWindowsUpdate
{
    ...
    public class WUTools : PSCmdlet
    {
        ...
        {
            if (Computer.ToLower() == "localhost" || Computer.ToLower() == "." || Computer.ToLower() == "127.0.0.1" ||
                Computer.ToLower() == "::1" ||
        ...
        public ErrorRecord ParseException(string Computer, Exception e)
        {
            return !Regex.IsMatch(e.Message, "800706BA", RegexOptions.IgnoreCase)
                ? !Regex.IsMatch(e.Message, "80070005", RegexOptions.IgnoreCase)
                    ...
                    : new ErrorRecord(new Exception(Computer + ": Access denied. You don't have permission to perform this task."),
                        "80070005", ErrorCategory.PermissionDenied,
                        null)
                : new ErrorRecord(new Exception(Computer + ": Connection failure, check firewall on destination machine."), "800706BA",
                ...
                try
                {
                    updateServiceManager =
                        (UpdateServiceManager)Activator.CreateInstance(
                            Marshal.GetTypeFromCLSID(new Guid("F8D253D9-89A4-4DAA-87B6-1168369F0B21")));
        ...
        public PSObject GetUpdateSessionObj(string Computer)
        {
            ...
            if (IsLocalHost(Computer))
            {
                ...
                {
                    updateSession =
                        (UpdateSession)Activator.CreateInstance(Marshal.GetTypeFromCLSID(new Guid("4CB43D7F-7EEE-4906-8698-60DA1C38F2FE")));
                    pSObject.Properties.Add(new PSNoteProperty("Status", true));
                ...
                try
                {
                    updateInstaller =
                        (UpdateInstaller)Activator.CreateInstance(
                            Marshal.GetTypeFromCLSID(new Guid("D2E0FE7F-D23E-48E1-93C0-6FA8CC346474")));
                    pSObject.Properties.Add(new PSNoteProperty("Status", true));
        ...
        public PSObject GetSystemInfoObj(string Computer)
        {
            ...
            if (IsLocalHost(Computer))
            {
                ...
                {
                    systemInformation =
                        (SystemInformation)Activator.CreateInstance(
                            Marshal.GetTypeFromCLSID(new Guid("C01B9BA0-BEA7-41BA-B604-D0A36F469133")));
                    pSObject.Properties.Add(new PSNoteProperty("Status", true));
        ...
        public WUAPIObject GetWUApiSystemInfoObj(string Computer)
        {
            ...
            if (IsLocalHost(Computer))
            {
                try
                {
                    @object = (SystemInformation)Activator.CreateInstance(
                        Marshal.GetTypeFromCLSID(new Guid("C01B9BA0-BEA7-41BA-B604-D0A36F469133")));
                    wUAPIObject.Status = true;
        ...
        public PSObject GetAutoUpdateObj(string Computer)
        {
            ...
            if (IsLocalHost(Computer))
            {
                try
                {
                    var value = (AutomaticUpdates)Activator.CreateInstance(
                        Marshal.GetTypeFromCLSID(new Guid("BFE18E9C-6D87-4450-B37C-E02F0B373803")));
                    pSObject.Properties.Add(new PSNoteProperty("Status", true));
        ...
        public WUAPIObject GetWUApiAutoUpdateObj(string Computer)
        {
            ...
            if (IsLocalHost(Computer))
            {
                try
                {
                    var @object = (AutomaticUpdates)Activator.CreateInstance(
                        Marshal.GetTypeFromCLSID(new Guid("BFE18E9C-6D87-4450-B37C-E02F0B373803")));
                    wUAPIObject.Status = true;
                    wUAPIObject.Object = @object;
                }
            ...
            if (IsLocalHost(Computer))
            {
                try
                {
                    windowsUpdateAgentInfo =
                        (WindowsUpdateAgentInfo)Activator.CreateInstance(
                            Marshal.GetTypeFromCLSID(new Guid("C2E88C2F-6F5B-4AAA-894B-55C847AD3A2D")));
                    pSObject.Properties.Add(new PSNoteProperty("Status", true));
        ...
        public ErrorRecord CheckPSWUModule(string Computer)
        {
            ...
            try
            {
                ...
                return version2 < version1
                    ? new ErrorRecord(
                        new Exception("To Invoke-WUJob you need PSWindowsUpdate " + version1 +
                                      " on destination machine! Current module version is " +
                                      version2), "LowModuleVersion", ErrorCategory.ResourceUnavailable, null)
                    : null;
            }
            catch
            {
                return new ErrorRecord(new Exception("PSWindowsUpdate module missing on destination machine"), "ModuleMissing",
                                ...
                                if (!(optionName == "Style"))
                                {
                                    ...
                                    else
                                    {
                                        var errorRecord = new ErrorRecord(
                                            new Exception("Missing " + optionName +
                                                          "; Use -PSWUSettings or declare PSWUSettings.xml in ModuleBase path."),
                ...
                else
                {
                    switch (str)
                    {
                        ...
                        case "Style":
                            continue;
                        case "Subject":
                            hashtable.Add((object)"Subject",
                                (object)(Environment.MachineName + ": Windows Update report " + DateTime.Now.ToString()));
                            goto case "Style";
                        default:
            ...
            return new Dictionary<string, WUApiCode>
            {
                ...
                },
                {
                    ...
                    new WUApiCode
                    {
                        ...
                        Description =
                            " callback was marked to be disconnected later because the request to disconnect the operation came while a callback was executing."
                    }
                },
                {
                    "0x00240005",
                ...
                },
                {
                    ...
                    new WUApiCode
                    {
                        ...
                        Description =
                            "CreateInstance failed for UpdateServiceManager Class not registered. Probably you use wrong Service Manager."
                    }
                },
                {
                    "0x80070005",
                    new WUApiCode
                    {
                        ...
                        Description =
                            "Probably you don't have permission to perform this task or the authentication method is not supported."
                    }
                },
                {
                    "0x800706BE",
